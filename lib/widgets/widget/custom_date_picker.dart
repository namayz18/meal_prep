...
class CustomDatePicker extends StatefulWidget {
  ...
  final DateTime? minDate; // Maximum selectable date
  final DateTime? maxDate; // Initially selected date
...
class _CustomDatePickerState extends State<CustomDatePicker> {
  ...
  void _onSelectedItemChanged(int index, _SelectorType type) {
    ...
    _selectedDate = temp; // adjust other selectors when one selctor is changed
    switch (type) {
      case _SelectorType.day:
        _selectedDayIndex = index;
        break;
      case _SelectorType.month:
        _selectedMonthIndex = index; // if month is changed to february &
      ...
      case _SelectorType.year:
        _selectedYearIndex =
            index; // if selected month is february & selected day is 29
